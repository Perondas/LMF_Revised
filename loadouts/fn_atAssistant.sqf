...
/*
	...
	*
	* Example:
	* [cursorObject] call lmf_loadout_fnc_atAssistant;
	*
	* Return Value:
...
//PRIMARY
[_unit,_Gun_ATA] call lmf_loadout_fnc_givePrimary;
...
for "_i" from 1 to 2 do {_unit addItem (selectRandom _MAT_Ammo);};
